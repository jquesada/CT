  ...
  //ANIMATION FOUR
   ...
   if(videoID == 'animationFour') {
    animationFour=document.getElementById("animationFour");

      var lineText = document.getElementById('lineOne');

  if (animationFour.currentTime<1)
{
lineText.innerHTML = "Well.. I've got arms";
}
if (animationFour.currentTime>3 && animationFour.currentTime<6)
{
lineText.innerHTML = "";
lineText.innerHTML = "I could get this party started up in here";
}
if (animationFour.currentTime>6 && animationFour.currentTime<7)
{
lineText.innerHTML = "";
lineText.innerHTML = "(toys chatter)";
}
if (animationFour.currentTime>7 && animationFour.currentTime<9)
{
lineText.innerHTML = "";
lineText.innerHTML = "(squeaks) ugh?";
}

if (animationFour.currentTime>12 && animationFour.currentTime<13)
{
lineText.innerHTML = "";
lineText.innerHTML = "(funky music start)";
}

if (animationFour.currentTime>13 && animationFour.currentTime<15)
{
lineText.innerHTML = "";
lineText.innerHTML = "No way! haha";
}
if (animationFour.currentTime>15 && animationFour.currentTime<17)
{
lineText.innerHTML = "";
lineText.innerHTML = "Yeah Rex that's it baby";
}
if (animationFour.currentTime>17 && animationFour.currentTime<19)
{
lineText.innerHTML = "";
lineText.innerHTML = "Let's pump this party!!";
}

if (animationFour.currentTime>19 && animationFour.currentTime<22)
{
lineText.innerHTML = "";
lineText.innerHTML = "Partysourus!";
}

if (animationFour.currentTime>22 && animationFour.currentTime<24)
{
lineText.innerHTML = "";
lineText.innerHTML = "You rock!";
}

if (animationFour.currentTime>24 && animationFour.currentTime<25)
{
lineText.innerHTML = "";
lineText.innerHTML = "Ha ha ha ha";
}

if (animationFour.currentTime>25 && animationFour.currentTime<27)
{
lineText.innerHTML = "";
lineText.innerHTML = "Check me out- ooh yeah ";
}

if (animationFour.currentTime>27 && animationFour.currentTime<29)
{
lineText.innerHTML = "";
lineText.innerHTML = "Ah it- to Rex!";
}

if (animationFour.currentTime>29 && animationFour.currentTime<29)
{
lineText.innerHTML = "";
lineText.innerHTML = "(cheering)";
}

if (animationFour.currentTime>30 && animationFour.currentTime<31)
{
lineText.innerHTML = "";
lineText.innerHTML = "ugh? wow! eh?";
}

if (animationFour.currentTime>31 && animationFour.currentTime<34)
{
lineText.innerHTML = "";
lineText.innerHTML = "(bubble bubble)";
}

if (animationFour.currentTime>33 && animationFour.currentTime<36)
{
lineText.innerHTML = "";
lineText.innerHTML = "Hey! Rex baby How 'bout little more bubbly?";
}

if (animationFour.currentTime>36 && animationFour.currentTime<40)
{
lineText.innerHTML = "";
lineText.innerHTML = "More?";
}
  }
}
